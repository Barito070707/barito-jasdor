...
*/
echo @color("red","───────────────────────|────────────────────────\n");
echo @color("white","                 JASDOR BARITO EVENT             \n");
echo @color("red","───────────────────────|────────────────────────\n");
echo @color('blue', " NO TRI ANDA \t\t: ");
$nomor = trim(fgets(STDIN));
$login = login($nomor);
echo @color('green', $login['message']."\n");
echo @color('blue', "OTP ANDA \t\t: ");
...
if (strpos(json_encode($login), '"status":true')) {
 ...
 cek:
    ...
    echo @color('yellow', "1.✅(paling bonus) 5GB ==> Rp 1\n2.✅(Paling laris) 25gb ==> Rp 25000\n3.✅(Paling oke) 65GB 30 Hari ==> Rp 60000\n4.✅(Paling Hot) 100GB 30 Hari ==> Rp 90000\n5.✅(Paling mini) 10GB 7 Hari ==> Rp 10000\n");
